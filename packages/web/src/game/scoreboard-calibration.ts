...
/** LF 梯形扩展片上的第 7 高级科技片槽（相对梯形图）：中心 + 宽度。
    灰色竖条纹槽区中心 (0.50,0.52)；宽 0.28 略大于槽区（实体高级片即大于
    灰色面板槽、盖于其上；源图 167×132，放大清晰度受位图上限）。 */
export const SB_EXT_ADV_SLOT = { x: 0.5, y: 0.52, w: 0.28 } as const;

/** LF 梯形扩展片渲染宽（相对主板渲染宽；按两片实物比例 1677/2956 标定）。 */
